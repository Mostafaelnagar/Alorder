package app.grand.tafwak.presentation.companies.adapter
...
import com.structure.base_mvvm.databinding.ItemCompanyBinding
...
//      clickEvent.value = data
  ...
  inner class ViewHolder(itemView: View) :
    ...
    private lateinit var itemLayoutBinding: ItemCompanyBinding
