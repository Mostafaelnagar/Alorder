package app.grand.tafwak.presentation.my_orders.adapters
...
import com.structure.base_mvvm.databinding.ItemMyOrderBinding

class MyOrdersAdapter : RecyclerView.Adapter<MyOrdersAdapter.ViewHolder>() {
  var clickEvent: SingleLiveEvent<Companies> = SingleLiveEvent()
  ...
  inner class ViewHolder(itemView: View) :
    ...
    private lateinit var itemLayoutBinding: ItemMyOrderBinding
