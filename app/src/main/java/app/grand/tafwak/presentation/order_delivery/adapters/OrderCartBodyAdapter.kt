...
import com.structure.base_mvvm.databinding.ItemOrderBodyBinding

class OrderCartBodyAdapter : RecyclerView.Adapter<OrderCartBodyAdapter.ViewHolder>() {
  ...
  inner class ViewHolder(itemView: View) :
    ...
    lateinit var itemLayoutBinding: ItemOrderBodyBinding
