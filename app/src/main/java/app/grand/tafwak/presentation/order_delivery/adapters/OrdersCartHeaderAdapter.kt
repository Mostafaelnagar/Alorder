...
import com.structure.base_mvvm.databinding.ItemOrderHeaderBinding

class OrdersCartHeaderAdapter : RecyclerView.Adapter<OrdersCartHeaderAdapter.ViewHolder>() {
  ...
  inner class ViewHolder(itemView: View) :
    RecyclerView.ViewHolder(itemView) {
     lateinit var itemLayoutBinding: ItemOrderHeaderBinding
